...
pub fn get_elements_for_single_line(figure_pair: Pair<Rule>) -> Vec<Element> {
    match figure_pair.as_str() {
        "d" => vec![
            Element::radius(45.0),
            Element::line(45.0),
            Element::combining(0, Element::line(45.0)),
            Element::line(45.0),
            Element::radius(-45.0),
        ],
        "id" => vec![
        ...
        "v" => vec![
            Element::radius(90.0),
            Element::line(90.0),
            Element::combining(0, Element::line(90.0)),
            Element::line(90.0),
            Element::radius(-90.0),
        ],
        "iv" => vec![
...
pub fn get_elements_for_loop_figure(figure_pair: Pair<Rule>) -> Vec<Element> {
    match figure_pair.as_str() {
        ...
        "o" => vec![
            ...
            Element::combining(0, Element::radius(20.0)),
            Element::radius(170.0),
        ],
        "io" => vec![
            Element::radius(-170.0),
        ...
        "dq" => vec![
            ...
            Element::radius(90.0),
            Element::invline(-45.0),
            Element::combining(0, Element::invline(-45.0)),
            Element::invline(-45.0),
            Element::radius(90.0),
            Element::line(-45.0),
            Element::radius(45.0),
        ...
        "idq" => vec![
            ...
            Element::radius(-90.0),
            Element::invline(45.0),
            Element::combining(1, Element::invline(45.0)),
            Element::invline(45.0),
            Element::radius(-90.0),
            Element::line(45.0),
            Element::radius(-45.0),
...
pub fn get_elements_for_loop_line_combo(figure_pair: Pair<Rule>) -> Vec<Element> {
    match figure_pair.as_str() {
        ...
        "rp" => vec![
            Element::radius(90.0),
            Element::line(90.0),
            Element::combining(-1, Element::line(90.0)),
            Element::line(90.0),
            Element::radius(270.0),
        ],
        "irp" => vec![
...
pub fn get_elements_for_double_loop(figure_pair: Pair<Rule>) -> Vec<Element> {
    match figure_pair.as_str() {
        "cc" => vec![
            Element::line(0.0),
            Element::combining(-1, Element::line(0.0)),
            Element::radius(225.0),
            Element::invline(-45.0),
            Element::combining(1, Element::invline(-45.0)),
            Element::invline(-45.0),
        ...
        "rcc" => vec![
            ...
            Element::invline(45.0),
            Element::radius(225.0),
            Element::combining(0, Element::line(0.0)),
            Element::line(0.0),
        ],
        "oo" => vec![
        ...
        "ooo" => vec![Element::radius(360.0), Element::radius(-360.0)],
        _ => {
            unreachable!();
        }
    }
...
pub fn get_elements_for_hammerhead(figure_pair: Pair<Rule>) -> Vec<Element> {
    match figure_pair.as_str() {
        ...
        "dhd" => vec![
            ...
            Element::stall(180.0, 0.0),
            Element::line(-90.0),
            Element::combining(2, Element::line(-90.0)),
            Element::line(-90.0),
            Element::radius(45.0),
            Element::line(-45.0),
            Element::combining(0, Element::line(-45.0)),
...
pub fn get_elements_for_extra(figure_pair: Pair<Rule>) -> Vec<Element> {
    match figure_pair.as_str() {
        "mm" => vec![Element::radius(180.0), Element::radius(-180.0)],
        "zb" => vec![
            Element::radius(135.0),
            Element::invline(45.0),
            Element::combining(-1, Element::invline(45.0)),
        ...
        "zy" => vec![
            ...
            Element::invline(45.0),
            Element::radius(-225.0),
            Element::invline(-90.0),
            Element::combining(0, Element::invline(-90.0)),
            Element::invline(-90.0),
            Element::radius(90.0),
        ],
        _ => {
    ...
    if turn_rolls == 1.5 {
        ...
        return vec![
            Element {
                ...
                aux_angle: initial_direction * 360.0,
                ..Element::new(ElementType::Turn)
            },
            Element {
                main_angle: turn_angle_per_roll * 0.5,
                aux_angle: initial_direction * -180.0,
                ..Element::new(ElementType::Turn)
            },
        ];
    }
